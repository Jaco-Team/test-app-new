...
export default function AddressModalMobile({ city }) {
  ...
  const [token, setActiveModalCityList] = useHeaderStoreNew((state) => [
    state?.token,
  ...
  const [
    ...
    setClearAddr,
    clearAddr,
    setActiveGetAddressModal,
  ] = useProfileStore((state) => [
    state.openModalAddress,
    state.setActiveAddressModal,
    state.setClearAddr,
    state.clearAddr,
      ...
      <div className="ContainerAddressModal">
          ...
          <div className="map" style={{ minHeight: '93.162393162393vw' }}>
            ...
            >
              <Map
                ...
                width="100%"
                height="100%"
                style={{ minHeight: '93.162393162393vw' }}
              >
                {!chooseAddrStreet ||
                Object.entries(chooseAddrStreet).length === 0 ? (
                  false
                ) : (
                  <Placemark
        ...
        <div className="addressForm">
          ...
          <div
            ...
            style={{ marginTop: '5.1282051282051vw' }}
          >
