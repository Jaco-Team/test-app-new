...
export default function OrderPC({ this_module, city }) {
  const [getOrderList] = useProfileStore((state) => [
    state.getOrderList,
    state.orderList,
  ]);
  ...
  return (
    ...
    >
      <Grid className="Zakazy mainContainer">
        <Grid size={12}>
        ...
        <Grid size={12} className="blockTable">
          <OrdersList token={token} this_module={this_module} city={city} />
        </Grid>
      </Grid>
