...
export default function ModalAddr_Test(){

  const ref2 = useRef();

  const [ clearAddr, chooseAddrStreet, center_map, zones, isOpenModalAddr_test, closeModalAddr, allStreets, checkStreet, saveNewAddr, infoAboutAddr, cityList, updateStreetList, active_city, updateAddr, getAddrList ] = 
    useProfileStore( state => [ state.clearAddr, state.chooseAddrStreet, state.center_map, state.zones, state.isOpenModalAddr_test, state.closeModalAddr, state.allStreets, state.checkStreet, state.saveNewAddr, state.infoAboutAddr, state.cityList, state.updateStreetList, state.active_city, state.updateAddr, state.getAddrList ] );
