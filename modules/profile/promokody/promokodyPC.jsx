...
export default function PromokodyPC({ this_module, city }) {
  const [getPromoList, promoListActive] = useProfileStore((state) => [
    state.getPromoList,
    state.promoListActive,
  ]);
  ...
  return (
    ...
    >
      <Grid className="Promokody mainContainer">
        <Grid size={12}>
        ...
        <Grid size={12} className="promo_list_active">
