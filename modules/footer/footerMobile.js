...
export default function FooterMobile({ cityName, active_page, links }) {
  ...
  const [itemsCount, itemsOffDops, dopListCart, checkPromo, allPrice] =
    useCartStore((state) => [
      state.itemsCount,
      state.itemsOffDops,
      state.dopListCart,
  ...
  const totalToShow =
    (checkPromo?.st && itemsOffDops.length ? allPrice : null) ?? baseTotal;
    ...
    ? {
        marginTop:
          ...
          (active_page === 'home' &&
            ...
            : undefined,
        transform:
          active_page === 'contacts' ? 'translate(0, -50%)' : undefined,
      }
    : {
        marginTop:
          active_page === 'sitemap' ||
  ...
  return (
    <>
      ...
      >
        ...
        <div
          className={
            showArrow && active_page !== 'cart' ? 'ArrowMobile' : 'ArrowHidden'
          }
          onClick={scrollUp}
      ...
      <footer
        ...
        style={{
          minHeight: cookie ? '128.20512820513vw' : '165.29914529915vw',
        }}
      >
        <div
        ...
        >
          ...
          <div className="row" style={{ marginBottom: '11.965811965812vw' }}>
            <div
              className="column"
              style={{
                marginRight: '2.991452991453vw',
                paddingLeft: '0.85470085470085vw',
                width: '36.752136752137vw',
              }}
            >
