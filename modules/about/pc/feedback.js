  ...
  return (
    <Grid size={12} id={'tag7'}>
      ...
      <p>
        ...
        <br />
        <Link href={'https://vk.com/jacofood_tlt'} target="_blank">
          Жако в Тольятти Вконтакте
        </Link>
        <br />
        <Link href={'https://vk.com/jacofood_smr'} target="_blank">
          Жако в Самаре Вконтакте
        </Link>
        <br />
        <Link href={'https://t.me/jacofood'} target="_blank">
          Жако в Телеграм
        </Link>
        <br />

        <Link href={'https://ok.ru/group/54671948841166'} target="_blank">
        ...
        <span>
          ...
          <Link href={'https://b24-rzeh1q.bitrix24site.ru/'} target="_blank">
            анкету.
          </Link>
        </span>
      </p>
