...
export default function ModalItemMobile() {
  const [openItemCard, item_card, setActiveModalCardItemMobile] = useHomeStore(
    (state) => [
      state.openItemCard,
      state.item_card,
    ...
    <>
            ...
            <div className="ItemContainer">
                ...
                <picture>
                  <source
                    ...
                    srcSet={
                      ...
                      ${process.env.NEXT_PUBLIC_YANDEX_IMG}${img_name}_466x466.webp 183w,
                      ${process.env.NEXT_PUBLIC_YANDEX_IMG}${img_name}_585x585.webp 233w,
                      ${process.env.NEXT_PUBLIC_YANDEX_IMG}${img_name}_732x732.webp 292w,
                  ...
                  <source
                    ...
                    srcSet={
                      ...
                      ${process.env.NEXT_PUBLIC_YANDEX_IMG}${img_name}_585x585.jpg 233w,
                      ${process.env.NEXT_PUBLIC_YANDEX_IMG}${img_name}_732x732.jpg 292w,
              ...
              <div className="DopModalCardMobile">
                <div className="dop_text">
                  {parseInt(item_card?.cat_id) == 5 ||
                  parseInt(item_card?.cat_id) == 6 ||
                  parseInt(item_card?.cat_id) == 7 ||
                  parseInt(item_card?.cat_id) == 15 ? null : (
                    <span className="second_text">
                      {parseInt(item_card?.cat_id) == 14
                        ? item_card?.size_pizza
                        : item_card?.count_part}
                      {parseInt(item_card?.cat_id) == 14
                        ? ' см'
                        : parseInt(item_card?.cat_id) == 6
                          ? ' л'
                  ...
                  <span
                    ...
                    style={{
                      justifyContent:
                        parseInt(item_card?.cat_id) == 4
                          ? 'flex-end'
                          : 'center',
                    }}
                  >
                    {new Intl.NumberFormat('ru-RU').format(item_card?.weight)}
                    {parseInt(item_card?.id) == 17 ||
                    parseInt(item_card?.id) == 237
                      ? ' шт.'
                      : parseInt(item_card?.cat_id) == 6
                        ? ' л'
                        : ' г'}
                ...
                <div
                  ...
                  style={{
                    visibility:
                      item_card?.id === '17' || item_card?.id === '237'
                        ? 'hidden'
                        : 'visible',
                  }}
                >
              ...
              <div>
                ...
                <span>
                  {count +
                    ...
                    'за' +
                    ' ' +
                    count * parseInt(item_card?.price)}{' '}
                  ₽
                </span>
      ...
      >
        <div className="ContainerModalCardMobileValue">
          ...
          <div
            className="dop_text_value"
            style={{
              marginBottom:
                item_card?.items.length < 2
                  ? '10.25641025641vw'
                  : '5.1282051282051vw',
            }}
          >
          ...
          <div
            ...
            style={{
              marginRight:
                item_card?.items.length < 2 ? '6.8376068376068vw' : 0,
              marginBottom:
                item_card?.items.length < 2 ? '17.094017094017vw' : 0,
            }}
          >
            <div
              className="ItemModalCardMobileValue"
              style={{
                overflowY: item_card?.items.length < 2 ? 'hidden' : 'auto',
              }}
