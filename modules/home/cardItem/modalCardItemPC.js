                ...
                <div className="FirstItem">
                  <div className="Table">
                    <div className="Title">
                      ...
                      >
                        Сет состоит из {openItem?.items.length} роллов:
                      </Typography>
                    </div>
                  ...
                  <div className="Table">
                    <div className="Title">
                      ...
                      <div className="ValueTitle">
                        ...
                        >
                          Полное описание состава блюд, калорийности и возможных
                          аллергенов можно{' '}
                          <Link
                      ...
                      <div className="ValueModeButtons">
                        <button
                          type="button"
                          className={
                            'ValueModeBtn ItemTitleValue ' +
                            (valueMode === 'per100' ? 'active' : '')
                          }
                    ...
                    <div className="List">
                      {valueItems.map((item, idx, arr) => (
                        <div
                          ...
                          className={
                            'ValueItem ' +
                            (idx === arr.length - 1 ? 'valueItemLastLong' : '')
                          }
                        >
                    ...
                    {parseInt(openItem?.cat_id) === 14 && (
                      <div className="ValueFootnote">
                        <Typography component="p" className="ItemPizza">
                          * Размер заготовки. После&nbsp;выпекания возможно
                          изменение размера на&nbsp;1–2&nbsp;см.
                        </Typography>
                      </div>
                    )}
                  </div>
            ...
            >
              <Grid className="SecondItem">
                  ...
                  <div className="dop_text">
                    {parseInt(openItem?.cat_id) != 4 ? null : (
                      <span
                        ...
                        style={{
                          cursor: typeModal === 'start' ? 'pointer' : null,
                        }}
                      >
                    ...
                    <span
                      className={
                        'third_text ' +
                        (parseInt(openItem?.count_part) == 1 &&
                        parseInt(openItem?.cat_id) !== 20 &&
                        parseInt(openItem?.cat_id) !== 21
                          ? 'dopThirdNoPad'
                          : 'dopThirdPad')
                      }
                    >
                ...
                <Typography
                  variant="h5"
                  component="div"
                  className="desc ItemDescStart"
                >
                  {(openItem?.marc_desc_full?.length ?? 0) > 0
                ...
                {count == 0 ? (
                  ...
                  <div className="containerBTN">
                    <div
                      style={{
                        backgroundColor:
                          typeModal === 'start' ? '#ffff' : '#E6E6E6',
                      }}
                      onClick={
                        typeModal === 'start' ? null : () => navigate('start')
                      }
                    >
                      <button
                        className="minus"
