...
export default function CreatePWD_PC() {
  //console.log('render CreatePWD_PC');
  ...
  const [navigate, setPwdLogin, pwdLogin, checkLoginKey] = useHeaderStore((state) => [state.navigate, state.setPwdLogin, state.pwdLogin, state.checkLoginKey]);
  ...
  return (
    <div className="modalLoginPwdPC">

      <div className="loginSubHeader">
        <Typography component="span">Надёжный пароль содержит буквы, цифры и символы</Typography>
      </div>
      ...
      <div className="createInputBox">
            ...
            startAdornment={
              <InputAdornment position="start">
                <div className='groupCheckPass'>
                  ...
                  <span style={{ marginBottom: '0.72202166064982vw', background: level_1 ? '#88EC59' : 'rgba(0, 0, 0, 0.10)' }}></span>
                </div>
              </InputAdornment>
            }
          />
        ...
        style={{ backgroundColor: passEqual && passReady ? '#DD1A32' : 'rgba(0, 0, 0, 0.1)' }}>
