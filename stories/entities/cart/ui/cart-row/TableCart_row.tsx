    ...
    >
      ...
      <td>
        ...
        <div>
          <span
            className={
              status_promo && (new_one_price || disabled) ? 'promoInfo' : null
            }
          >
            {new Intl.NumberFormat('ru-RU').format(
              parseInt(one_price) * parseInt(count)
            )}{' '}
            ₽
          </span>
      ...
      <td>
        ...
        <button
          ...
          style={{
            backgroundColor:
              disabled || count > 98 ? '#fff' : 'rgba(0, 0, 0, 0.05)',
            color:
              disabled || count > 98
                ? 'rgba(0, 0, 0, 0.2)'
                : 'rgba(0, 0, 0, 0.8)',
          }}
          disabled={disabled || count > 98 ? true : false}
        >
          +
        </button>
      </td>
