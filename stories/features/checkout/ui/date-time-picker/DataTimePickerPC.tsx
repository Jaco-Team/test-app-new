    ...
    <div className="dataTimePickerPC">
      ...
      <section className="sandbox__carousel">
        ...
        <DataTime
          slides={slidesTime}
          data={'time'}
          active={slidesTime?.length < 4 ? 0 : 1}
        />
      </section>
    ...
    <>
      <div
        ...
        style={{
          ...
          bottom: '11.552346570397vw',
          left: data === 'date' ? '8.6642599277978vw' : '15.342960288809vw',
        }}
      >
        <ArrowBackIosNewIcon />
      </div>
      ...
      >
        <div className="embla__viewport">
          <div
            ...
            style={{
              width:
                data === 'date' ? '12.996389891697vw' : '7.2202166064982vw',
            }}
          >
            {slides?.map((item, i) => (
              <div
                ...
                style={{
                  ...
                  marginLeft: data === 'date' ? '1.4440433212996vw' : undefined,
                }}
              >
